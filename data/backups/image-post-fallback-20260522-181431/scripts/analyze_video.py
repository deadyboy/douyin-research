...
from lib.vision_ocr import (
    ...
    analyze_video_file, analyze_frame_verification,
...
def _append_videos_jsonl(
    ...
    record = {
        ...
        "source": "SSR HTML (_ROUTER_DATA) + direct video input + ffmpeg scene-change verification",
        "analysis_mode": "video-first+scene-verification+ocr-fallback",
        "video_first_ok": video_first_ok,
        "video_usage": video_usage,
